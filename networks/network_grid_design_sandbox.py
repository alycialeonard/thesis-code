# Sandbox for grid design work. Built from PowerAfrica submission
...
buildings = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\data\\clustering_toy_dataset\\gis_osm_buildings_a_free_1_EvenSmallerSample.geojson'

# File paths to save final results
clustering_results = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\clustering_results.geojson'
analysis_results_csv = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\analysis_results.csv'
analysis_results = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\analysis_results.geojson'
console_output = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\output.txt'
knee_graph = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\knee_graph.png'
cluster_graph = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\cluster_graph.png'
tree_shapefiles = 'C:\\Users\\alyci\\PycharmProjects\\GeoDESA\\results\\grid_design\\shapefile_exports'


# --------------- FUNCTIONS --------------- #

# Find the knee of a set of data following a curve up or down
# Inputs: number of points in dataset, ordered data points
...
# Set stdout to print to output file (comment out if not desired)
...
# --------------- DISTRIBUTION GRIDS: DELAUNAY & MST FOR EACH CLUSTER --------------- #
...
# Instantiate dictionary to hold mean coordinates, no. of buildings, Delaunay tri, and min span tree for each cluster
mean_coord = {}
building_count = {}
delaunay = {}
min_span_tree = {}
...
for cluster in cluster_ids:
    ...
    # Get total distance of all edges in the tree (i.e. conductor in distribution grid)
...
print("Lengths of conductor used in each cluster (MST): ", total_conductor_length)
print("Lengths of conductor used in each cluster (radial): ", total_conductor_length_radial)

# --------------- TRANSMISSION GRIDS: DELAUNAY & MST BETWEEN CLUSTERS --------------- #
...
# Save transmission grid shapefiles
T_save = nx.relabel_nodes(T, loc)
T_dir = T_save.to_directed()
...
# Plot MSTs from Delaunay Triangulations
plt.figure()
