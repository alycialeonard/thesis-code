# Clustering of home footprint centroids with DBSCAN
...
# Do DBSCAN, fit to our data
clustering = DBSCAN(eps=0.001, min_samples=10).fit(X)
...
centroids.to_file("centroids_DBSCAN_eps001_min10.shp")
