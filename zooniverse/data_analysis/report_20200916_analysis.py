# Analysis for 9th September 2016 Zooniverse report
...
# Settings
data = "C:\\Users\\alyci\\Documents\\DPhil\\GeoDESA\\Zooniverse\\DataExports\\DataExport_20200922\\power-to-the-people-classifications.csv"
...
#mask = (pttp['created_at_utc'] > pd.datetime(2020, 3, 1))  # & (pttp['created_at_utc'] < pd.datetime(2020, 9, 1))
#pttp_live = pttp.loc[pttp['created_at_utc'] > pd.datetime(2020, 3, 1)]
...
#boxes.to_csv('C:\\Users\\alyci\\Documents\\DPhil\\GeoDESA\\Zooniverse\\DataExports\\DataExport_20200904\\boxes_since_launch.csv')
...
#pttp_live_homescount.to_csv("C:\\Users\\alyci\\Documents\\DPhil\\GeoDESA\\Zooniverse\\DataExports\\DataExport_20200904\\Classifications_Homes_Count.csv")
...
#pttp_live_subjectid.to_csv("C:\\Users\\alyci\\Documents\\DPhil\\GeoDESA\\Zooniverse\\DataExports\\DataExport_20200904\\Classifications_Per_SubjectID.csv")
